...
| 2. | [HTML CS](https://htmlcheatsheet.com/) | HTML, CSS, JS Interactive Cheat Sheet |
| 3. | [HTML Entities](https://dev.w3.org/html5/html-author/charref) | List of HTML Entities/Characters |
| 4. | [Markdown CS](https://github.com/tchapi/markdown-cheatsheet/blob/master/README.md) | Markdown Cheat Sheet |
...
| Sr. | Site | Description |
|---|---|---|
| 1. | [Replit](https://repl.it/~) | All in One online IDE <br/> Has auto-save feature |
